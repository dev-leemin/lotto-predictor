...
export const metadata: Metadata = {
  title: '개인정보처리방침',
  description: 'Lotto45 서비스 개인정보처리방침입니다.',
  alternates: { canonical: 'https://lotto45.kr/privacy-policy' },
}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 pb-24 lg:pb-8">
        ...
        <div className="space-y-10 text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Lotto45(이하 &quot;서비스&quot;)는 이용자의 개인정보를 소중히 여기며,
          ...
          <section>
            ...
            <p className="mb-4">
              Lotto45는 별도의 회원가입 절차가 없으며, 이용자로부터 직접적으로
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-gray-50 border border-gray-200">
                <h3 className="font-bold text-gray-900 mb-2">자동 수집 정보</h3>
              ...
              <div className="p-4 rounded-xl bg-gray-50 border border-gray-200">
                <h3 className="font-bold text-gray-900 mb-2">쿠키(Cookies)</h3>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-xl bg-gray-50 border border-gray-200">
                <h3 className="font-bold text-gray-900 mb-1">Google AdSense</h3>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-500">
              <li>
                <span className="text-gray-900 font-medium">쿠키 거부:</span>{' '}
                브라우저 설정에서 쿠키 수집을 차단하거나 삭제할 수 있습니다.
              </li>
              <li>
                <span className="text-gray-900 font-medium">맞춤 광고 비활성화:</span>{' '}
                <a
              ...
              <li>
                <span className="text-gray-900 font-medium">정보 삭제 요청:</span>{' '}
                수집된 정보에 대한 삭제를 요청할 수 있습니다.
              </li>
              <li>
                <span className="text-gray-900 font-medium">열람 및 정정 요청:</span>{' '}
